                    ...
                    <table id="myTable" class="min-w-full align-middle text-sm">
                        <thead>
                            <tr class="border-b-2 border-zinc-100">
                                <th class="px-3 py-2 text-start text-sm font-semibold tracking-wider text-zinc-700 uppercase">
                                    No</th>
                                <th
                                ...
                                <tr class="border-b border-zinc-100 hover:bg-zinc-50">
                                    ...
                                    <td class="p-3 text-start">
                                        <div class="flex items-center space-x-2">
                                            ...
                                            <a href="{{ route('admin.mangas.edit', $manga->id) }}" class="text-blue-500 hover:underline" title="Edit Manga">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20"
                                                    fill="currentColor">
