...
<div class="container mx-auto px-4 my-12">
    ...
    <div class="flex flex-col md:flex-row items-stretch md:items-center justify-between mb-6 gap-3">
        ...
        <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 w-full md:w-auto">
            <a href="#" class="btn btn-outline w-full sm:w-auto flex items-center justify-center sm:justify-start gap-2" @if(!$previousChapter) disabled @endif aria-label="Chapter Sebelumnya">
            ...
            <a href="#" class="btn btn-outline w-full sm:w-auto flex items-center justify-center sm:justify-start gap-2" @if(!$nextChapter) disabled @endif aria-label="Chapter Berikutnya">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
    ...
    <!-- Manga Pages -->
    <div id="manga-reader" tabindex="0" class="bg-base-200 p-4 rounded-lg shadow-md border border-base-200/40">
        @foreach ($pages as $page)
            <img src="{{ asset('images/' . $page) }}" alt="Manga Page" class="w-full mb-4 rounded-lg border-4 border-base-200/40">
        @endforeach
    </div>
</div>
