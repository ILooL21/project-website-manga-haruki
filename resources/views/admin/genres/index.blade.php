                                ...
                                <tr class="border-b border-zinc-100 hover:bg-zinc-50">
                                    ...
                                    <td class="p-3 text-start">
                                        <div class="flex items-center gap-2">
                                            ...
                                            <form action="{{ route('admin.genres.destroy', $genre->id) }}" method="POST" class="inline" title="Delete Genre">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" onclick="loading(event, this, true, 'Apakah Anda yakin ingin menghapus genre ini?')" class="text-red-500 hover:text-red-700">
