                    ...
                    <table id="myTable" class="min-w-full align-middle text-sm">
                        <thead>
                            <tr class="border-b-2 border-zinc-100">
                                ...
                                <th class="px-3 py-2 text-start text-sm font-semibold tracking-wider text-zinc-700 uppercase">Nama</th>
                                <th class="px-3 py-2 text-start text-sm font-semibold tracking-wider text-zinc-700 uppercase">Email</th>
                                <th class="px-3 py-2 text-start text-sm font-semibold tracking-wider text-zinc-700 uppercase">Role</th>
                                ...
                                <tr class="border-b border-zinc-100 hover:bg-zinc-50">
                                    ...
                                    <td class="p-3 text-start">
                                        <div class="flex items-center gap-2">
                                            ...
                                            <button class="text-blue-500 hover:text-blue-700 hover:cursor-pointer" title="View User">
                                            ...
                                            <button class="text-blue-500 hover:text-blue-700 hover:cursor-pointer" title="Edit User">
