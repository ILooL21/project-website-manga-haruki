...
<div x-data="{ open:false, title:'', description:'', status:'ongoing', genresText:'', reset(){ this.title=''; this.description=''; this.status='ongoing'; this.genresText=''; }, }">
    ...
    <div x-cloak x-show="open" class="fixed inset-0 z-50 flex items-center justify-center" @keydown.escape.window="open=false">
        ...
        <div class="relative z-10 w-full max-w-xl rounded-lg bg-white text-zinc-900 shadow-xl">
            ...
            <form action="{{ route('admin.mangas.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4 p-5">
                @csrf
                <div>
    ...
    <div class="container mx-auto p-4 lg:p-8 xl:max-w-7xl">
        <div class="flex flex-col rounded-lg border border-zinc-200 bg-white">
            <div
                ...
                <div>
                    {{-- <h2 class="mb-0.5 font-semibold">All Mangas</h2> --}}
                                ...
                                <tr class="border-b border-zinc-100 hover:bg-zinc-50">
                                    ...
                                    <td class="p-3 text-start">
                                        <div class="flex items-center space-x-2">
                                            <a href="" class="text-blue-500 hover:underline" title="Edit Manga">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20"
                                                    fill="currentColor">
                                                    <path
                                                        d="M17.414 2.586a2 2 0 00-2.828 0L7 10.172V13h2.828l7.586-7.586a2 2 0 000-2.828z" />
                                                    <path fill-rule="evenodd"
                                                        d="M5 13.828V15h1.172l7.586-7.586-1.172-1.172L5 13.828z"
                                                        clip-rule="evenodd" />
                                                </svg>
                                            </a>
                                            <form action="" method="POST" class="inline" title="Delete Manga">
                                                @csrf
                                                @method('DELETE')
                                            ...
                                            <a href="{{ route('manga.chapters', $manga->id) }}"
                                                class="text-green-500 hover:underline" title="View Chapters">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20"
                                                    fill="currentColor">
                                                    <path
