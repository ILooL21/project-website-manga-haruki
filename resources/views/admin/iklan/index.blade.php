                                ...
                                <tr class="border-b border-zinc-100 hover:bg-zinc-50">
                                    ...
                                    <td class="p-3 text-start font-semibold text-zinc-600">{{ $iklan->section }}</td>
                                        ...
                                        <td class="p-3 text-start">
                                            @if($iklan->image_path)
                                                <x-cloudinary::image
                                                    public-id="{{ $iklan->image_public_id }}"
                                            ...
                                            <form action="{{ route('admin.iklan.destroy', urlencode(\Illuminate\Support\Facades\Crypt::encryptString($iklan->id))) }}" method="POST" class="inline" title="Delete Iklan">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" onclick="loading(event, this, 'Apakah Anda yakin ingin menghapus iklan ini?')" class="text-red-500 hover:text-red-700">
